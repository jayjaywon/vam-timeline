...
namespace VamTimeline
{
    public static class CurveTypeValues
    {
        ...
        private static readonly List<string> _indexedCurveTypes = new List<string> { LeaveAsIs, Flat, Linear, Smooth, Bounce, LinearFlat, FlatLinear, CopyPrevious, Constant };
        public static readonly List<string> DisplayCurveTypes = new List<string> { LeaveAsIs, Flat, Linear, Smooth, Constant, Bounce, LinearFlat, FlatLinear, CopyPrevious };
